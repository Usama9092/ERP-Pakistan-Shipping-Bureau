...
[data-testid="stSidebarContent"]::-webkit-scrollbar-thumb { background:rgba(120,170,176,.28); border-radius:9px; }
.psb-global-nav-label, .psb-project-nav-label { color:#90B0B8; font-size:9px; font-weight:900; letter-spacing:1.15px; text-transform:uppercase; margin:4px 4px 10px; }
.psb-sidebar-divider { height:1px; background:rgba(255,255,255,.10); margin:12px 0 10px; }
[data-testid="stSidebar"] [data-testid="stRadio"] > div { display:flex !important; flex-direction:column !important; gap:4px !important; width:100% !important; overflow:visible !important; }
