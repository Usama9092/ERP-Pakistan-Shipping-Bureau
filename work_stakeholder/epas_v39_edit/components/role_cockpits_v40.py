"""EPAS v4.1.3 PSB-reference-aligned role cockpits."""
...
def render(role):
    ...
    s=_summary()
    st.markdown(f"<div class='ref-page-kicker'>PAKISTAN SHIPPING BUREAU · EPAS v4.1.3</div><h1 class='ref-page-title'>{html.escape(title)}</h1><div class='ref-page-subtitle'>{html.escape(sub)}</div>",unsafe_allow_html=True)
    defaults={
