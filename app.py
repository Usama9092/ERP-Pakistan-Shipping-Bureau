...
def apply_style() -> None:
    ...
    css = (
        ...
        "\n"
        + theme_css
        + "\n.stApp{background:linear-gradient(135deg,var(--psb-surface-elevated) 0%,var(--psb-surface) 56%,var(--psb-surface-alt) 100%);color:var(--psb-text)}"
        ...
        + "\n.login-card{background:var(--psb-card);border:1px solid var(--psb-line);border-radius:30px;padding:2rem;box-shadow:0 18px 55px rgba(15,23,42,.10)}"
